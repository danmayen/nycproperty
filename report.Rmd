...
From the overall 17 data attributes remaining, the following data properties 
are elicited for each column:
...
```{r RMSE function}
RMSE_price <- function(pred_ratings, true_ratings) {
